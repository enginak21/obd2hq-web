...
export const warningLights: Record<string, WarningLight> = {
  'check-engine': {
    ...
    iconSvg: '<img src="/icons/check-engine.jpg" alt="Check Engine Light" width="96" height="96" class="w-full h-full object-cover mix-blend-screen rounded-full" />',
  ...
  'abs': {
    ...
    iconSvg: '<img src="/icons/abs.jpg" alt="ABS Warning Light" width="96" height="96" class="w-full h-full object-cover mix-blend-screen rounded-full" />',
  ...
  'oil-pressure': {
    ...
    iconSvg: '<img src="/icons/oil-pressure.jpg" alt="Oil Pressure Warning Light" width="96" height="96" class="w-full h-full object-cover mix-blend-screen rounded-full" />',
  ...
  'battery': {
    ...
    iconSvg: '<img src="/icons/battery.jpg" alt="Battery Warning Light" width="96" height="96" class="w-full h-full object-cover mix-blend-screen rounded-full" />',
  ...
  'tpms': {
    ...
    iconSvg: '<img src="/icons/tpms.jpg" alt="TPMS Warning Light" width="96" height="96" class="w-full h-full object-cover mix-blend-screen rounded-full" />',
  ...
  'coolant-temp': {
    ...
    iconSvg: '<img src="/icons/coolant-temp.jpg" alt="Coolant Temperature Warning Light" width="96" height="96" class="w-full h-full object-cover mix-blend-screen rounded-full" />',
  ...
  'brake': {
    ...
    iconSvg: '<img src="/icons/brake.jpg" alt="Brake System Warning Light" width="96" height="96" class="w-full h-full object-cover mix-blend-screen rounded-full" />',
  ...
  'airbag': {
    ...
    iconSvg: '<img src="/icons/airbag.jpg" alt="Airbag Warning Light" width="96" height="96" class="w-full h-full object-cover mix-blend-screen rounded-full" />',
  ...
  'traction': {
    ...
    iconSvg: '<img src="/icons/traction.jpg" alt="Traction Control Warning Light" width="96" height="96" class="w-full h-full object-cover mix-blend-screen rounded-full" />',
