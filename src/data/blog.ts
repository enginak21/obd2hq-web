...
const postsEN: BlogPost[] = [
  ...
  },
  {
    ...
    content: `
      ...
      <p>Continue with the verified <a href="/en/codes/p0300" class="text-blue-400 font-bold hover:underline">P0300 code hub</a>, then compare related misfire pages such as <a href="/en/codes/p0203" class="text-blue-400 font-bold hover:underline">P0203 injector circuit diagnosis</a> and <a href="/en/warning-lights" class="text-blue-400 font-bold hover:underline">dashboard warning light guidance</a>.</p>
      <h2>Bottom Line</h2>
