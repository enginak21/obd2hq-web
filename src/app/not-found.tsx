...
export default function NotFound() {
  return (
    <main className="min-h-[80vh] bg-[#0a0f1c] text-slate-200 font-sans flex flex-col items-center justify-center p-6 text-center">
      ...
      <h2 className="text-2xl font-bold text-slate-300 mb-6">Engine Misfire: Page Not Found</h2>
      
      <p className="text-xl text-slate-400 font-light max-w-2xl mx-auto mb-8">
        You&apos;ve navigated to a diagnostic code or page that doesn&apos;t exist in our mechanic&apos;s manual. Let&apos;s get you back to the garage.
      </p>
