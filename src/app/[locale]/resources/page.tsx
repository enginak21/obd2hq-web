...
const copy = {
  en: {
    ...
    intro: 'Use these resources to reference OBD2 codes, help drivers find safer first checks, and link back to the original OBD2HQ diagnostic guides.',
    ...
    attribution: 'Attribution: link to OBD2HQ when you use the dataset, widget or checklist publicly.',
    open: 'Open resource',
  },
  tr: {
    ...
    intro: 'Bu kaynakları OBD2 kodlarına referans vermek, sürücülere güvenli ilk kontrolleri göstermek ve OBD2HQ rehberlerine kaynak bağlantısı vermek için kullanabilirsiniz.',
    ...
    attribution: 'Atıf: Veri seti, widget veya checklisti herkese açık kullanırken OBD2HQ bağlantısı verin.',
    open: 'Kaynağı aç',
  },
  de: {
...
export default async function ResourcesPage({ params }: PageProps) {
  ...
  const resources = [
    ...
    { title: c.lights, href: `/${locale}/symptoms`, icon: ImageIcon, note: 'ABS, battery, oil, coolant, SRS, TPMS' },
    { title: c.checklist, href: `/${locale}/blog/how-to-fix-p0420`, icon: FileText, note: 'Freeze-frame, live data, first checks' },
